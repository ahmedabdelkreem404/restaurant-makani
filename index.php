...
?>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						<h1>Makani</h1>
						<h2>to make people happy</h2>
						<hr>
						<p>"❤️ مكاني هو مكانك"</p>
	...
	<section class="our_menus" id="menus">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px"> OUR MENUS</h2>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <h3>
						<i style='font-size:24px' class='fas'>&#xf4d7; Location : </i>
    ...
    <section class="widget_section" style="background-color: #222227;padding: 30px 0;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/makani-logo2.png" alt="Restaurant-makani" style="width: 200px;margin-bottom: 20px;">
						<p class="col-lg-8 " >In our restaurant, you can reserve a table or place an order that will be delivered to your door.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                     <div class="footer_widget">
                        ...
                        <p >
                            ...
                            <?php echo $restaurant_phonenumber; ?>
							<br>
							Our pages on social networking sites
                        </p>
